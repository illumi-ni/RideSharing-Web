            ...
            <div className ='Register_container'>
                ...
                <form>
                    ...
                    <h5 for="gender"><label className="regstyle">Gender</label>
                        <input type="radio" value="Male" name="gender" checked={this.state.selectedOption === "Male"}
                        onChange={this.onValueChange}/> Male
                        <input type="radio" value="Female" name="gender" checked={this.state.selectedOption === "Female"}
                        onChange={this.onValueChange} /> Female
                        <input type="radio" value="Other" name="gender" checked={this.state.selectedOption === "Other"}
